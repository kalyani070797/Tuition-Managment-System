<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Student Portal.aspx.cs" Inherits="Tuition_Managment_System.Student_Portal" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Label ID="Lbl_StudentPortal" runat="server" CssClass="auto-style1" Text="Student Portal"></asp:Label>
            <br />
            <br />
            <br />
            <br />
